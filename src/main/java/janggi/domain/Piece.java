...
public class Piece {
    ...
    public List<Route> availableMovePositions(Position currentPosition) {
        return pieceBehavior.generateMovePosition(side, currentPosition);
    }
    ...
    public boolean isCannon() {
        return pieceBehavior.getClass() == Cannon.class;
    }
